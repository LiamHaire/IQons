...
const FOLDER_MAP: Record<string, FolderConfig> = {
  ...
  "Calendar & scheduling": { id: "calendar-scheduling", prefix: "calendar" },
  "Communications":      { id: "communications",   prefix: "communications" },
  "Sharing":             { id: "sharing",          prefix: "sharing" },
  "Documents & content": { id: "documents-content", prefix: "documents" },
  "Workflow & productivity": { id: "workflow-productivity", prefix: "workflow" },
  "User & ID":           { id: "user-id",          prefix: "user" },
  "Status & feedback":   { id: "status-feedback",  prefix: "status" },
  "Security & access":   { id: "security-access",  prefix: "security" },
  "Analytics & reports": { id: "analytics-reports", prefix: "analytics" },
  "Settings & admin":    { id: "settings-admin",   prefix: "settings" },
  "System & utility":    { id: "system-utility",   prefix: "system" },
  "AI":                  { id: "ai",               prefix: "ai" },
