...
const VARIANTS: Partial<Record<string, string>> = {
  outline: `<path d="M12 9C12.4142 9 12.75 9.33579 12.75 9.75V13.25H16.25C16.6642 13.25 17 13.5858 17 14C17 14.4142 16.6642 14.75 16.25 14.75H12.75V18.25C12.75 18.6642 12.4142 19 12 19C11.5858 19 11.25 18.6642 11.25 18.25V14.75H7.75C7.33579 14.75 7 14.4142 7 14C7 13.5858 7.33579 13.25 7.75 13.25H11.25V9.75C11.25 9.33579 11.5858 9 12 9Z" fill="currentColor"/>
