...
<path d="M13 20.5V22H11V20.5H13ZM13.5 20V10C13.5 9.72386 13.2761 9.5 13 9.5H11C10.7239 9.5 10.5 9.72386 10.5 10V20C10.5 20.2761 10.7239 20.5 11 20.5V22L10.7959 21.9893C9.78722 21.887 9 21.0357 9 20V10C9 8.89543 9.89543 8 11 8H13C14.1046 8 15 8.89543 15 10V20C15 21.1046 14.1046 22 13 22V20.5C13.2761 20.5 13.5 20.2761 13.5 20Z" fill="currentColor"/>
...
<path d="M9 10C9 8.89543 9.89543 8 11 8H13C14.1046 8 15 8.89543 15 10V20C15 21.1046 14.1046 22 13 22H11C9.89543 22 9 21.1046 9 20V10Z" fill="currentColor" fill-opacity="0.2"/>
...
IconSignalLow.displayName = "IconSignalLow";
IconSignalLow.variants = AVAILABLE;
