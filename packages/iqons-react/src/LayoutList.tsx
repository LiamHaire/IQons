...
const VARIANTS: Partial<Record<string, string>> = {
  outline: `<circle cx="3.5" cy="5.5" r="1.5" fill="currentColor"/>
<circle cx="3.5" cy="18.5" r="1.5" fill="currentColor"/>
<circle cx="3.5" cy="12" r="1.5" fill="currentColor"/>
<path d="M21.25 4.75C21.6642 4.75 22 5.08579 22 5.5C22 5.91421 21.6642 6.25 21.25 6.25H7.25C6.83579 6.25 6.5 5.91421 6.5 5.5C6.5 5.08579 6.83579 4.75 7.25 4.75H21.25Z" fill="currentColor"/>
<path d="M21.25 17.75C21.6642 17.75 22 18.0858 22 18.5C22 18.9142 21.6642 19.25 21.25 19.25H7.25C6.83579 19.25 6.5 18.9142 6.5 18.5C6.5 18.0858 6.83579 17.75 7.25 17.75H21.25Z" fill="currentColor"/>
<path d="M21.25 11.25C21.6642 11.25 22 11.5858 22 12C22 12.4142 21.6642 12.75 21.25 12.75H7.25C6.83579 12.75 6.5 12.4142 6.5 12C6.5 11.5858 6.83579 11.25 7.25 11.25H21.25Z" fill="currentColor"/>`,
  ...
  duotone: `<rect x="8" y="5" fill="currentColor" fill-opacity="0.2"/>
<circle cx="3.5" cy="5.5" r="1.5" fill="currentColor"/>
<circle cx="3.5" cy="18.5" r="1.5" fill="currentColor"/>
<circle cx="3.5" cy="12" r="1.5" fill="currentColor"/>
<path d="M21.25 4.75C21.6642 4.75 22 5.08579 22 5.5C22 5.91421 21.6642 6.25 21.25 6.25H7.25C6.83579 6.25 6.5 5.91421 6.5 5.5C6.5 5.08579 6.83579 4.75 7.25 4.75H21.25Z" fill="currentColor"/>
<path d="M21.25 17.75C21.6642 17.75 22 18.0858 22 18.5C22 18.9142 21.6642 19.25 21.25 19.25H7.25C6.83579 19.25 6.5 18.9142 6.5 18.5C6.5 18.0858 6.83579 17.75 7.25 17.75H21.25Z" fill="currentColor"/>
