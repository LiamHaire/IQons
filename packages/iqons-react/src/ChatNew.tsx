...
const VARIANTS: Partial<Record<string, string>> = {
  outline: `<path d="M12 7.75C12 11.3461 12 12.6539 12 16.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
<path d="M7.75 12H16.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
