...
const VARIANTS: Partial<Record<string, string>> = {
  outline: `<circle cx="11" cy="11" r="10.25" transform="matrix(1 0 0 -1 1 23)" stroke="currentColor" stroke-width="1.5"/>
<path d="M7.75 10.25L11.9293 14.4293C11.9683 14.4683 12.0317 14.4683 12.0707 14.4293L16.25 10.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>`,
...
<circle cx="11" cy="11" r="10.25" transform="matrix(1 0 0 -1 1 23)" stroke="currentColor" stroke-width="1.5"/>
<path d="M7.75 10.25L11.9293 14.4293C11.9683 14.4683 12.0317 14.4683 12.0707 14.4293L16.25 10.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>`,
};
